...
public static void sparqlTest(){
	...
	// Requ�tte pour Prefix de fichier RDF 
	...
	// ### nom du r�alisateur du film Twins
	...
	// ### Liste des titres, r�alisateurs et dates de sortie des films ordonn�es par la date de sortie.
...
try{
	...
	while(results2.hasNext()){
		...
		System.out.println("Titre : "+Titre+ "|| R�aliser par : "+ Realisateur+ " || Date : "+Date);
	}
}
finally {
	qexec1.close();
